...
class GR_OnlineTensorLDA:
    def __init__(self, worker_idx, alpha, betaO_o, betaD_o, betaT_o, num_station, num_time, J, K, L, M, S, iterEM, EM_CONVERGED, EM_CONVERGED_fine_tune, iterInference, VAR_CONVERGED, tau0, kappa, _updatect):
        """
        Explanation:
    ...
    def fit(self, i, docs_minibatch, lam, mu, nu, G_net, G_poi, dictionary_o, dictionary_d, dictionary_t, idx_corpus_o, idx_corpus_d, idx_corpus_t, num_user, num_station, num_time):
        """ 
